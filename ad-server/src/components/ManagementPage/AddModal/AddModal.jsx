  ...
  const renderPreview = () => {
    if(ad.src) {
      if(ad.buttonAlign === "Left") {
        return(
          <div className="preview" style={{textAlign: "left", backgroundImage: `url(${ad.src})`}}>
        ...
        return(
          <div className="preview" style={{backgroundImage: `url(${ad.src})`}}>
            <div className="previewText">
              <h3>{ad.title}</h3>
              <h5>{ad.subtitle}</h5>
            </div>
            ...
            <Col sm={8}>
              ...
              <Row>
                ...
                <Col sm={6}>
                  ...
                  <Form.Control as="select"
                    onChange={ (e) => setAd({...ad, buttonAlign: e.target.value }) } 
                    >
                  ...
                  <Form.Control 
                    placeholder="http://" 
                    onChange={ (e) => setAd({...ad, buttonUrl: e.target.value }) } 
                  />
                </Col>
              </Row>
            </Col>
